...
export class MaterialTableComponent implements OnInit, AfterViewInit {
	...
	constructor(private http: HttpClient) {
		const users: UserData[] = [
			{
				"id": "ce6588f7-1544-49e1-bdca-d9c1913e79b8",
				"lastName": "Саитов",
				"firstName": "Ренат",
				"middleName": "",
				"email": "rfsaitov@gmail.com",
				"admin": true,
				"secretar": false,
				"manager": false,
				"chairman": true,
			...
			{
				"id": "c5d223ab-cbc4-46d2-ad92-3c49d2594767",
				"lastName": "Зернова",
				"firstName": "Мария",
				"middleName": "",
				"email": "zernovamaria@gmail.com",
				"admin": true,
				"secretar": false,
				"manager": false,
				"chairman": false,
			...
			{
				"id": "79c1c506-0763-490e-af0d-233b9ec42548",
				"lastName": "Бойков",
				"firstName": "Максим",
				"middleName": "",
				"email": "bmi@gaskarconsulting.com",
				"admin": false,
				"secretar": false,
				"manager": false,
				"chairman": false,
			...
			{
				"id": "7ae6b517-50d6-441c-a46c-10509c569ecf",
				"lastName": "Арделян",
				"firstName": "Виталий",
				"middleName": "",
				"email": "ardelyan.vitaly@gmail.com",
				"admin": false,
				"secretar": false,
				"manager": false,
				"chairman": false,
			...
			},
			{
				...
				"firstName": "Валерий",
				"middleName": "",
				"email": "valery.lobachev@gmail.com",
				"admin": true,
				"secretar": true,
				"manager": true,
				"chairman": true,
